    ...
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Create and manage test users for different subscription tiers
        </p>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
          ...
          <ol className="text-sm text-blue-800 dark:text-blue-200 space-y-1 list-decimal list-inside">
            <li>Click "Create Test Users" to set up test accounts</li>
            <li>Use the provided credentials to log in as different user types</li>
            <li>Test feature restrictions (free users should see upgrade prompts)</li>
            <li>Verify subscription status and usage limits</li>
            <li>Test the payment flow with the premium user</li>
          </ol>
        </div>
      </CardContent>
    </Card>
